...
interface PrivilegedGitHub {

    fun release(versionNumber: ReleaseVersion): ReleaseOutcome
    fun uploadArtifact(releaseId: ReleaseId, targetName: String, label: String, path: Path): UploadArtifactOutcome
    ...
    sealed interface UploadArtifactOutcome {
        ...
        data class Failure(val failure: release.github.Failure) : UploadArtifactOutcome
    }
}