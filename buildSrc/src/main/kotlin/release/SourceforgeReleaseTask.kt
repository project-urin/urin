    ...
    fun release() {
        ...
        try {
            retrying {
                ...
                it.execute("mkdir --parents /home/frs/project/urin/${project.version}")
            }
            retrying {
                SshClient.SshClientBuilder.create()
                ...
                it.executePut(documentationTar, "/home/project-web/urin/documentation-${project.version}.tgz")
                it.executePut(combinedJar, "/home/frs/project/urin/${project.version}/urin-${project.version}.jar")
                it.executePut(smallJar, "/home/frs/project/urin/${project.version}/urin-small-${project.version}.jar")
            }
            retrying {
                SshClient.SshClientBuilder.create()
                    .withHostname("shell.sourceforge.net")
                ...
                it.execute(
                    "mkdir --parents /home/project-web/urin/${project.version}",
