...
public class QueryTest {
    ...
    public void parsesUnreservedCharacters() throws Exception {
        assertThat(Query.BASE_QUERY_DECODER.decode(QUERY_AND_FRAGMENT_CHARACTERS), equalTo(Query.query(QUERY_AND_FRAGMENT_CHARACTERS)));
    }

    @Test
    public void parsesNonUnreservedCharacters() throws Exception {
        assertThat(Query.BASE_QUERY_DECODER.decode(".%23.%5B.%5D.%20."), equalTo(Query.query(".#.[.]. .")));
    }
