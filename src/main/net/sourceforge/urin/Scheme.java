...
public abstract class Scheme {
    ...
    private static final class RelativeReferenceNoAuthority extends RelativeReference {
        ...
        Urin resolve(final Scheme scheme, final Authority authority, final Path path) {
            return scheme.urin(backdoorHierarchicalPart(authority, path).resolve(this.path));
        }
        ...
        Urin resolve(final Scheme scheme, final Authority authority, final Path path, final Query query, final Fragment fragment) {
            if (this.path.isEmpty()) {
                return scheme.urin(backdoorHierarchicalPart(authority, path).resolve(this.path), query, fragment);
            } else {
                return scheme.urin(backdoorHierarchicalPart(authority, path).resolve(this.path));
            }
        }
    ...
    private static final class RelativeReferenceWithAuthority extends RelativeReference {
        ...
        @Override
        Urin resolve(final Scheme scheme, final Authority authority, final Path path) {
            return scheme.urin(backdoorHierarchicalPart(authority, path).resolve(this.authority, this.path));
        }
    ...
    private static final class RelativeReferenceNoAuthorityWithFragment extends RelativeReference {
        ...
        Urin resolve(final Scheme scheme, final Authority authority, final Path path, final Query query, final Fragment fragment) {
            if (this.path.isEmpty()) {
                return scheme.urin(backdoorHierarchicalPart(authority, path).resolve(this.path), query, this.fragment);
            } else {
                return scheme.urin(backdoorHierarchicalPart(authority, path).resolve(this.path), this.fragment);
            }
        }
    ...
    private static final class RelativeReferenceNoAuthorityWithQueryAndFragment extends RelativeReference {
        ...
        @Override
        Urin resolve(final Scheme scheme, final Authority authority, final Path path, final Query query, final Fragment fragment) {
            return scheme.urin(backdoorHierarchicalPart(authority, path).resolve(this.path), this.query, this.fragment);
        }
    ...
    private static final class RelativeReferenceWithAuthorityAndQuery extends RelativeReference {
        ...
        @Override
        Urin resolve(final Scheme scheme, final Authority authority, final Path path) {
            return scheme.urin(backdoorHierarchicalPart(authority, path).resolve(this.authority, this.path), query);
        }
        ...
        @Override
        Urin resolve(final Scheme scheme, final Authority authority, final Path path, final Query query) {
            return scheme.urin(backdoorHierarchicalPart(authority, path).resolve(authority, this.path), this.query);
        }
        ...
        @Override
        Urin resolve(final Scheme scheme, final Authority authority, final Path path, final Query query, final Fragment fragment) {
            return scheme.urin(backdoorHierarchicalPart(authority, path).resolve(this.authority, this.path), this.query);
        }
    ...
    private static final class RelativeReferenceWithAuthorityAndFragment extends RelativeReference {
        ...
        @Override
        Urin resolve(final Scheme scheme, final Authority authority, final Path path) {
            return scheme.urin(backdoorHierarchicalPart(authority, path).resolve(this.authority, this.path), fragment);
        }
        ...
        @Override
        Urin resolve(final Scheme scheme, final Authority authority, final Path path, final Query query) {
            return scheme.urin(backdoorHierarchicalPart(authority, path).resolve(authority, this.path), fragment);
        }
